...
<head>
    ...
    <title>@yield('title', 'Admin Panel') - {{ config('app.name', 'Monkey Island Quiz') }}</title>
    ...
    <!-- SweetAlert2 -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.0/dist/sweetalert2.min.css" crossorigin="anonymous">
    
    <!-- Custom Admin Styles -->
    <style>
        /* ตรวจสอบการโหลด Tailwind */
        .tailwind-test {
            @apply text-blue-500 p-4;
        }
        
        /* Fix compatibility between Bootstrap and Tailwind */
        .btn {
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <!-- SweetAlert2 -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.0/dist/sweetalert2.min.js" crossorigin="anonymous"></script>
